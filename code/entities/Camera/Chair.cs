...
public partial class CameraEntity : Prop, IUse
{
	...
	public override void Spawn()
	{
		...
		var modelName = "models/editor/camera.vmdl";
	...
	public bool OnUse( Entity user )
	{
		...
		{
			player.Vehicle = this;
			player.VehicleController = new CameraController();
			player.VehicleAnimator = new CameraAnimator();
			player.VehicleCamera = new PropCamera();
			player.Parent = this;
