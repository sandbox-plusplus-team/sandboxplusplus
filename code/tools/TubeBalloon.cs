...
{
	[Library( "tool_tubeballoon", Title = "Tube Balloons", Description = "Create Tube Balloons!", Group = "construction" )]
	public partial class TubeBalloonTool : BaseTool
	{
		[Net]
		...
		{
			if ( TryCreatePreview( ref previewModel, "models/citizen_props/balloontall01.vmdl") )
			{
		...
		public override void Simulate()
		{
			...
			using ( Prediction.Off() )
			{
				...
				ent.SetModel("models/citizen_props/balloontall01.vmdl");
